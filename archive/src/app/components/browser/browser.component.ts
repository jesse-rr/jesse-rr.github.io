...
import { DriveFile, FOLDER_MIME } from '../../music/models/drive.model';
...
export class BrowserComponent implements OnInit {
  ...
  // Document types filter categories (excluding "Notes")
  ...
  private async initBrowser() {
    try {
      ...
      console.error('Failed to resolve notes root folder:', error);
    }
  }
  ...
  // Filter logic based on search queries and category tags
  ...
  // Helper for generating web content link
